    ...
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-2 flex items-center justify-center">
          <span className="mr-3">🔍</span> Boolean Skill Extractor
        </h2>
        <p className="text-gray-600">Extract skills and create powerful boolean search strings for candidate sourcing</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          ...
          <div className="mb-6">
            <label htmlFor="jdInput" className="block text-lg font-medium text-gray-700 mb-3">
          ...
          <button
            ...
            className={`w-full py-4 px-6 rounded-2xl font-bold text-white text-lg shadow-xl transition-all duration-300 flex items-center justify-center ${
        ...
        <div>
          ...
          {results ? (
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                <div className="flex justify-between items-center mb-4">
                  <h4 className="text-lg font-bold text-gray-800">Primary Boolean String</h4>
                  <button
                    type="button"
                ...
                <div className="bg-gray-50 rounded-xl p-4 font-mono text-sm break-words">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                <h4 className="text-lg font-bold text-gray-800 mb-4">All Boolean Strings</h4>
                <div className="space-y-4">
                  {results.booleanStrings.map((booleanString, index) => (
                    <div key={index} className="border border-gray-200 rounded-xl p-4">
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-medium text-gray-700">{booleanString.platform}</span>
                        <button
                          type="button"
                      ...
                      <div className="bg-gray-50 rounded-lg p-3 font-mono text-xs break-words">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                <h4 className="text-lg font-bold text-gray-800 mb-4">Extracted Skills</h4>
            ...
            <div className="flex flex-col items-center justify-center h-full bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl border-2 border-dashed border-gray-300 p-8">
              <svg className="w-16 h-16 text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <p className="text-lg text-gray-600 text-center">Your extracted skills and boolean strings will appear here</p>
              <p className="text-sm text-gray-500 mt-2 text-center">Paste a job description and click "Extract Boolean Skills"</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-200">
        ...
        {!userId ? (
          <div className="text-center py-8">
            ...
            <p className="mt-1 text-gray-500">Please sign in to view your extraction history.</p>
          </div>
        ) : showHistory && (
          skillHistory.length === 0 ? (
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-lg font-medium text-gray-900">No skill extractions</h3>
              <p className="mt-1 text-gray-500">Get started by extracting skills from a job description.</p>
            </div>
          ) : (
