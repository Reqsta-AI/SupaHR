  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const sortedData = data.sort((a: OrganizedNote, b: OrganizedNote) => 
          new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
        );
        setHistory(sortedData);
        // Also save to localStorage as backup
        localStorage.setItem('smartOrganizerHistory', JSON.stringify(sortedData));
      } else {
        ...
        if (savedHistory) {
          ...
          // Sort by createdAt date (newest first)
          const sortedData = parsedHistory.sort((a: any, b: any) => 
            new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()
          );
          setHistory(sortedData);
        }
    ...
    while (retries <= maxRetries) {
      try {
        ...
        if (response.ok) {
          ...
          // Make sure to clear the interval and set processing to false
        ...
        <div className="flex flex-col">
          <div className="mb-6 relative">
            ...
            {isListening && interimTranscript && (
              <div className="absolute bottom-4 left-4 right-4 bg-blue-50 border border-blue-200 rounded-lg p-3 shadow-md">
            ...
            {aiOutput ? (
              <div className="bg-white border border-gray-200 rounded-xl p-5 h-[400px] overflow-y-auto shadow-inner">
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 mb-2">Priority</h4>
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800 mb-2">Tasks</h4>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {history
                ...
                .map((note) => (
                  <div 
                    key={note._id} 
                    className="border border-gray-200 rounded-xl p-4 hover:bg-gray-50 transition-all duration-200 cursor-pointer shadow-sm hover:shadow-md"
